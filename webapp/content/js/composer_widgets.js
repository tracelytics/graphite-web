...
function createFunctionsMenu() {
  return [{
      ...
      menu: [
        ...
        {text: 'Monotonic Increase', handler: applyFuncToEachWithInput('monotonicIncrease', 'Please enter the maximum number of "None" or decreasing datapoints to overwrite, or leave empty for no limit. (default: empty)', {allowBlank: true})},
